...
export class MasterService {
    ...
    getLineList(params: Partial<MasterParams>) {
        ...
        return this.http.get<HttpResponse<MasterRobot[]>>(
            `${this.baseUrlLine}/get-line-all`,
            {
                observe: 'response',
                params: params,
            }
    ...
    exportExcelLine() {
        this.http
            .get(`${this.baseUrlLine}/download-excel-line`, {
    ...
    getMachineList(params: Partial<MasterParams>) {
        ...
        return this.http.get<HttpResponse<MasterMachine[]>>(
            `${this.baseUrlMachine}/get-machine-all`,
            {
                observe: 'response',
                params: params,
            }
    ...
    createMachine(body: any) {
        return this.http.post<HttpResponse<any>>(
            `${this.baseUrlMachine}/create-machine`,
            body
        );
    }
    ...
    exportExcelMachine() {
        this.http
            .get(`${this.baseUrlMachine}/download-excel-machine`, {
                responseType: 'arraybuffer',
            })
            .subscribe(response => {
                downLoadFile(response);
    ...
    getSubjectList(params: Partial<MasterParams>) {
        ...
        return this.http.get<HttpResponse<MasterSubject[]>>(
            `${this.baseUrlSubject}/get-subject-all`,
            {
                observe: 'response',
                params: params,
            }
    ...
    createSubject(body: any) {
        return this.http.post<HttpResponse<any>>(
            `${this.baseUrlSubject}/create-subject`,
            body
        );
    }
    ...
    exportExcelSubject() {
        this.http
            .get(`${this.baseUrlSubject}/download-excel-subject`, {
                responseType: 'arraybuffer',
            })
            .subscribe(response => {
                downLoadFile(response);
    ...
    getListMachine() {
        return this.http.get<HttpResponse<MasterMachine[]>>(
            `${this.baseUrlMachine}/get-list-machine`
        );
    }

    createRobot(body: MasterRobot[]) {
        return this.http.post<HttpResponse<MasterRobot>>(
            `${this.baseUrlRobot}/create-robot`,
            body
        );
    }
    ...
    getRobotList(params: Partial<MasterParams>) {
        params = removeEmptyObject(params);
        return this.http.get<HttpResponse<MasterRobot[]>>(
            `${this.baseUrlRobot}/get-robot-all`,
            {
                observe: 'response',
                params: params,
            }
    ...
    deleteRobot(id: string) {
        return this.http.delete<HttpResponse<MasterRobot>>(
            `${this.baseUrlRobot}/${id}`
        );
    }

    updateRobot(id: string, body: MasterRobot[]) {
        return this.http.put<HttpResponse<MasterRobot>>(
            `${this.baseUrlRobot}/${id}`,
            body
        );
    }
    ...
    exportExcelRobot() {
        this.http
            .get(`${this.baseUrlRobot}/download-excel-robot`, {
                responseType: 'arraybuffer',
            })
            .subscribe(response => {
                downLoadFile(response);
