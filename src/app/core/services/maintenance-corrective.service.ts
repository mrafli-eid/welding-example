...
export class MaintenanceCorrectiveService {
    ...
    getList(machine_name: string, params: Partial<MasterParams>) {
        ...
        return this.http.get<HttpResponse<MaintenanceCorrective[]>>(`${ this.baseUrl }/get-maintenance-corrective-all/${ machine_name }`, {
            observe: 'response',
            params: params,
        });
    }
    ...
    getChart(machine_name: string, params: Partial<DateFilter>) {
        return this.http.get<HttpResponse<MaintenanceCorrectiveChart[]>>(`${ this.baseUrl }/get-maintenance-corrective-grafik-all/${ machine_name }`, { params });
    }

    create(body: any) {
        return this.http.post<HttpResponse<any>>(`${ this.baseUrl }/create-maintenance-corrective`, body);
    }
    ...
    exportExcel(machine_name: string, params: Partial<MasterParams>) {
        ...
        this.http.get(`${ this.baseUrl }/download-excel-corrective`, {
