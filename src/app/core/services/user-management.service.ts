...
export class UserManagementService {
    ...
    getRoleList() {
        return this.http.get<HttpResponse<RoleList[]>>(
            `${this.baseUrl}/permission/get-list-role`
        );
    }
    ...
    getListUser(params: Partial<MasterParams> = null) {
        ...
        return this.http.get<HttpResponse<UserListUserManagement[]>>(
            `${this.baseUrl}/users`,
            {
                observe: 'response',
                params: params,
    ...
    getListRole(params: Partial<MasterParams> = null) {
        ...
        return this.http.get<HttpResponse<RoleListUserManagement[]>>(
            `${this.baseUrlRole}/get-list-role`,
            {
                observe: 'response',
                params: params,
            }
    ...
    getListPermission(params: Partial<MasterParams> = null) {
        ...
        return this.http.get<HttpResponse<PermissionListUserManagement[]>>(
            `${this.baseUrlPermission}/get-list-permission`,
            {
                observe: 'response',
                params: params,
            }
    ...
    getListClaimType() {
        return this.http.get<HttpResponse<ClaimTypeListUserManagement[]>>(
            `${this.baseUrlPermission}/get-list-claim-type`
        );
    }

    createPermission(body: any) {
        return this.http.post<HttpResponse<any>>(
            `${this.baseUrlPermission}/create-permission`,
            body
        );
    }
    ...
    updatePermission(id: string, body: any) {
        return this.http.put<HttpResponse<any>>(
            `${this.baseUrlPermission}/update-permission/${id}`,
            body
        );
    }
    ...
    deletePermission(id: string) {
        return this.http.delete<HttpResponse<any>>(
            `${this.baseUrlPermission}/delete-permission/${id}`
        );
    }
}
