...
import {
    ...
    MaintenancePreventiveParams,
} from '../models/maintenance-preventive.model';
...
export class MaintenancePreventiveService {
    ...
    getList(machine_name: string, params: Partial<MasterParams>) {
        ...
        return this.http.get<HttpResponse<MaintenancePreventive[]>>(
            `${this.baseUrl}/get-maintenance-preventive-all/${machine_name}`,
            {
                observe: 'response',
                params: params,
            }
    ...
    getChart(machine_name: string, params: Partial<DateFilter>) {
        return this.http.get<HttpResponse<MaintenancePreventiveChart[]>>(
            `${this.baseUrl}/get-maintenance-preventive-grafik-all/${machine_name}`,
            { params }
        );
    }
    ...
    getSchedule(machine_name: string, start: Date, end: Date) {
        ...
        return this.http.get<HttpResponse<Schedule[]>>(
            `${this.baseUrl}/get-schedule/${machine_name}`,
            { params }
        );
    }
    ...
    create(body: any, params?: Partial<MaintenancePreventiveParams>) {
        return this.http.post<HttpResponse<any>>(
            `${this.baseUrl}/create-maintenance-preventive`,
            body,
            {
                params: params,
            }
    ...
    exportExcel(machine_name: string, params: Partial<MasterParams>) {
        ...
        this.http
            .get(`${this.baseUrl}/download-excel-preventive`, {
                params: queryParams,
