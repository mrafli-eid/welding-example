...
@Component({
    selector: 'ahm-chart-detail-machine-cnb-lub-oil-pressure',
    standalone: true,
    imports: [ CommonModule, NgChartsModule ],
    templateUrl: './chart-detail-machine-cnb-lub-oil-pressure.component.html',
    styleUrls: [ './chart-detail-machine-cnb-lub-oil-pressure.component.scss' ],
})
export class ChartDetailMachineCnbLubOilPressureComponent implements OnChanges {
    public lineChartType: ChartType = 'line';
    @ViewChild(BaseChartDirective) chart?: BaseChartDirective;

    @Input() data: DetailMachineCnbLubOilPressure[];
