...
@Component({
  selector: 'ahm-dashboard-chart-detail-servo-load',
  standalone: true,
  imports: [CommonModule, NgChartsModule],
  templateUrl: './dashboard-chart-detail-servo-load.component.html',
  styleUrls: ['./dashboard-chart-detail-servo-load.component.scss']
})
export class DashboardChartDetailServoLoadComponent {
