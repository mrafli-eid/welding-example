...
} from '../corrective-maintenance-list/corrective-maintenance-list.component';
...
export class CorrectiveMaintenanceContainerComponent {
    ...
    @ViewChild(CorrectiveMaintenanceListComponent) listComponent: CorrectiveMaintenanceListComponent;
