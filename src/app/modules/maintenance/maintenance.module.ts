...
import { PreventiveMaintenanceCalendarComponent } from './preventive-maintenance/preventive-maintenance-calendar/preventive-maintenance-calendar.component';
import { PreventiveMaintenanceGraphComponent } from './preventive-maintenance/preventive-maintenance-graph/preventive-maintenance-graph.component';
...
import { MaintenanceCalendarComponent } from '../dashboard/components/maintenance-schedule/maintenance-calendar/maintenance-calendar.component';
import { MaintenanceCalendarScheduleComponent } from '../dashboard/components/maintenance-schedule/maintenance-calendar-schedule/maintenance-calendar-schedule.component';
import { ChartProductionGraphComponent } from '../dashboard/components/production-graph/chart-production-graph.component';
...
import { PreventiveMaintenanceUpsertComponent } from './preventive-maintenance/preventive-maintenance-upsert/preventive-maintenance-upsert.component';
import { PreventiveMaintenanceDetailComponent } from './preventive-maintenance/preventive-maintenance-detail/preventive-maintenance-detail.component';
